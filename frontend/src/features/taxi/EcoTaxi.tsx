        ...
        <div className="main-taxi-content-div">
          ...
          <div className="taxi-info">
            ...
            <p className="taxicall-info">
              Специально для тех, кто не смог посетить акцию, мы предоставляем услуги ЭкоТакси. Для
              сдачи действуют те же правила: всё вторсырье должно быть чистым и сухим,
              рассортировано по категориям и собрано в один большой пакет или коробку для удобства
              транспортировки. Нет времени на разбор мягкого и твердого пластика? Доплати 200 рублей
              и волонтеры сделают это за тебя!
            </p>

            <Link to="https://ecotaxi.wastezero.ru/" className="calltaxi-btn">
              вызвать эко-такси
            </Link>
          </div>
        </div>
