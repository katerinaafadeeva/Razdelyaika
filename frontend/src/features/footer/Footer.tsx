...
import okLogo from './icons/OK.svg';
import vkLogo from './icons/VK.svg';
import instLogo from './icons/Inst.svg';

function Footer(): JSX.Element {
  return (
    <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 footer">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color mb-7  text_y">
                «Разделяйка» – это ежемесячная экологическая Акция по сбору вторсырья и
              ...
              <p className="text-dark flex items-center text-sm font-medium ">
                ...
                <span>
                  +7 (912) 309-44-33 <br /> Руководитель проекта
                </span>
              </p>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12 ">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text_y">Ресурсы</h4>
              <ul>
                <li>
                  <Link
                    to="https://recyclemap.ru/"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Recuclemap
                  </Link>
                </li>
                <li>
                  <Link
                    to="https://yandex.ru/maps/56/chelyabinsk/?ll=61.403860%2C55.165302&mode=usermaps&source=constructorLink&um=constructor%3A333779f7054cb7cd714cef7f3080f3a56cb8ece499805bbdabd84751e9a61e45&z=11"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base  text_w leading-loose">
                    Карта Разделяйки
                  </Link>
                </li>
                <li>
                  <Link
                    to="https://docs.google.com/forms/d/e/1FAIpQLScA88UQ9ZDdgoEhdXPKecCk8w4nOVXJ1RLNfeZ6U8tjHk47Mw/viewform"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base  text_w leading-loose">
                ...
                <li>
                  <Link
                    to="https://vk.com/zerowasteshop_reka"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base  text_w leading-loose">
                    Уральская Троба
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text_y">Вопросы</h4>
              <ul>
                <li>
                  <Link
                    to="https://vk.com/album-150793226_260492299"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Что можно приносить
                  </Link>
                </li>
                <li>
                  <Link
                    to="https://vk.com/wall-150793226_13881"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                ...
                <li>
                  <Link
                    to="https://vk.com/board150793226"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Найти ответ
                  </Link>
                </li>
                <li>
                  <Link
                    to="https://vk.com/app5727453_-150793226"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Помочь проекту
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text_y">Контакты</h4>
              <ul>
                <li>
                  <Link
                    to="https://vk.com/dzakarlyukin"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                ...
                <li>
                  <Link
                    to="https://vk.com/iskra_ra"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Куратор Парковой, медиа
                  </Link>
                </li>
                <li>
                  <Link
                    to="https://vk.com/annasogrina"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Куратор Мкр-н Чурилово
                  </Link>
                </li>
                <li>
                  <Link
                    to="https://vk.com/idbik04kab"
                    className="text-body-color hover:text-primary mb-2 inline-block text-base text_w  leading-loose">
                    Куратор Копейск
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-9 text-lg font-semibold text_y">Follow Us On</h4>
              <div className="mb-6 flex items-center">
                <Link
                  to="https://www.instagram.com/razdelyaika74/"
                  ...
                  <img src={instLogo} alt="" width="20px" />
                </Link>
                <Link
                  to="https://vk.com/razdelyaika74"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                  <img src={vkLogo} alt="" width="23px" />
                </Link>
                <Link
                  to="https://ok.ru/group/54702801682589"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                  <img src={okLogo} alt="" width="28px" />
                </Link>
              </div>
              <p className="text-body-color text-base text_b">2023 РАЗДЕЛЯЙКА</p>
            </div>
          </div>
        </div>
      </div>
